namespace :kasa do
  ...
  task fetch: :environment do
    ...
    if ENV['PHOTOS'] == '1'
      ...
      Property.all.each_with_index do |listing, serial_no|
        rets.get_photos(listing, serial_no,Propperty.all.size) #rescue puts "F95BA get_photos(#{listing['157']}, serial_no,listings.size)"

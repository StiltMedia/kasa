...
class AdvertsControllerTest < ActionController::TestCase
  ...
  test "should create advert" do
    assert_difference('Advert.count') do
      post :create, advert: { property_id: @advert.property_id, seed: @advert.seed, user_id: @advert.user_id }
    end
  ...
  test "should update advert" do
    patch :update, id: @advert, advert: { property_id: @advert.property_id, seed: @advert.seed, user_id: @advert.user_id }
    assert_redirected_to advert_path(assigns(:advert))
  end
